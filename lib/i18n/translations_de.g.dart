...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final TranslationsConstantsDe constants = TranslationsConstantsDe.internal(_root);
	late final TranslationsParkDurationDe park_duration = TranslationsParkDurationDe.internal(_root);
	late final TranslationsLoginDialogDe login_dialog = TranslationsLoginDialogDe.internal(_root);
	late final TranslationsParkDialogDe park_dialog = TranslationsParkDialogDe.internal(_root);
	late final TranslationsMarkerDialogDe marker_dialog = TranslationsMarkerDialogDe.internal(_root);
	late final TranslationsHomeDe home = TranslationsHomeDe.internal(_root);
	late final TranslationsHistoryDe history = TranslationsHistoryDe.internal(_root);
	late final TranslationsInfoSheetDe info_sheet = TranslationsInfoSheetDe.internal(_root);
	late final TranslationsTopHeaderDe top_header = TranslationsTopHeaderDe.internal(_root);
	late final TranslationsCarBottomSheetDe car_bottom_sheet = TranslationsCarBottomSheetDe.internal(_root);
	...
	late final TranslationsBottomSheetDe bottom_sheet = TranslationsBottomSheetDe.internal(_root);
	late final TranslationsSnackbarDe snackbar = TranslationsSnackbarDe.internal(_root);
...
class TranslationsParkDialogDe {
	...
	late final TranslationsParkDialogParkNameDe park_name = TranslationsParkDialogParkNameDe.internal(_root);
	String get content_2 => 'Zusätzliche Infos';
	late final TranslationsParkDialogInfoDe info = TranslationsParkDialogInfoDe.internal(_root);
	late final TranslationsParkDialogTicketDe ticket = TranslationsParkDialogTicketDe.internal(_root);
	late final TranslationsParkDialogPhotoDe photo = TranslationsParkDialogPhotoDe.internal(_root);
}
...
class TranslationsMarkerDialogDe {
	...
	// Translations
	late final TranslationsMarkerDialogSharedDe shared = TranslationsMarkerDialogSharedDe.internal(_root);
	late final TranslationsMarkerDialogMineDe mine = TranslationsMarkerDialogMineDe.internal(_root);
...
class TranslationsHomeDe {
	...
	late final TranslationsHomeQuickActionsDe quick_actions = TranslationsHomeQuickActionsDe.internal(_root);
}
...
class TranslationsHistoryDe {
	...
	late final TranslationsHistoryEmptyDe empty = TranslationsHistoryEmptyDe.internal(_root);
	late final TranslationsHistoryExportDe export = TranslationsHistoryExportDe.internal(_root);
	late final TranslationsHistoryDeleteDe delete = TranslationsHistoryDeleteDe.internal(_root);
}
...
class TranslationsCarBottomSheetDe {
	...
	// Translations
	late final TranslationsCarBottomSheetEmptyDe empty = TranslationsCarBottomSheetEmptyDe.internal(_root);
	late final TranslationsCarBottomSheetDistanceCalculationDe distance_calculation = TranslationsCarBottomSheetDistanceCalculationDe.internal(_root);
	late final TranslationsCarBottomSheetYouDe you = TranslationsCarBottomSheetYouDe.internal(_root);
	late final TranslationsCarBottomSheetFriendsDe friends = TranslationsCarBottomSheetFriendsDe.internal(_root);
	late final TranslationsCarBottomSheetMenuDe menu = TranslationsCarBottomSheetMenuDe.internal(_root);
}
...
class TranslationsMyCarDe {
	...
	late final TranslationsMyCarBuiltDe built = TranslationsMyCarBuiltDe.internal(_root);
	late final TranslationsMyCarDrivenDe driven = TranslationsMyCarDrivenDe.internal(_root);
	late final TranslationsMyCarPlateDe plate = TranslationsMyCarPlateDe.internal(_root);
	late final TranslationsMyCarParkNameDe park_name = TranslationsMyCarParkNameDe.internal(_root);
	late final TranslationsMyCarTuvDe tuv = TranslationsMyCarTuvDe.internal(_root);
...
class TranslationsMapsDe {
	...
	late final TranslationsMapsTrafficDe traffic = TranslationsMapsTrafficDe.internal(_root);
}
...
class TranslationsIntroDe {
	...
	// Translations
	late final TranslationsIntroPage1De page_1 = TranslationsIntroPage1De.internal(_root);
	late final TranslationsIntroPage2De page_2 = TranslationsIntroPage2De.internal(_root);
}
...
class TranslationsSnackbarDe {
	...
	// Translations
	late final TranslationsSnackbarLockedDe locked = TranslationsSnackbarLockedDe.internal(_root);
	late final TranslationsSnackbarSharedParkingDe shared_parking = TranslationsSnackbarSharedParkingDe.internal(_root);
	late final TranslationsSnackbarDistanceCalculationDe distance_calculation = TranslationsSnackbarDistanceCalculationDe.internal(_root);
}
...
class TranslationsDialogDe {
	...
	late final TranslationsDialogShareLocationParkingsDe share_location_parkings = TranslationsDialogShareLocationParkingsDe.internal(_root);
	late final TranslationsDialogDistanceDe distance = TranslationsDialogDistanceDe.internal(_root);
	late final TranslationsDialogNotificationsDe notifications = TranslationsDialogNotificationsDe.internal(_root);
	late final TranslationsDialogCarBottomSheetDe car_bottom_sheet = TranslationsDialogCarBottomSheetDe.internal(_root);
	late final TranslationsDialogMapsDe maps = TranslationsDialogMapsDe.internal(_root);
	late final TranslationsDialogHistoryDe history = TranslationsDialogHistoryDe.internal(_root);
	late final TranslationsDialogLeaveInfoDe leave_info = TranslationsDialogLeaveInfoDe.internal(_root);
	late final TranslationsDialogAppInfoDe app_info = TranslationsDialogAppInfoDe.internal(_root);
	late final TranslationsDialogFeedbackDe feedback = TranslationsDialogFeedbackDe.internal(_root);
	late final TranslationsDialogDataSecurityDe data_security = TranslationsDialogDataSecurityDe.internal(_root);
	late final TranslationsDialogAppDataDe app_data = TranslationsDialogAppDataDe.internal(_root);
	late final TranslationsDialogAccountDataDe account_data = TranslationsDialogAccountDataDe.internal(_root);
...
class TranslationsSettingsDe {
	...
	late final TranslationsSettingsThemeDe theme = TranslationsSettingsThemeDe.internal(_root);
	late final TranslationsSettingsColorDe color = TranslationsSettingsColorDe.internal(_root);
	late final TranslationsSettingsMapTypeDe map_type = TranslationsSettingsMapTypeDe.internal(_root);
	late final TranslationsSettingsTrafficDe traffic = TranslationsSettingsTrafficDe.internal(_root);
	late final TranslationsSettingsNewIosDe new_ios = TranslationsSettingsNewIosDe.internal(_root);
	late final TranslationsSettingsParkTicketDe park_ticket = TranslationsSettingsParkTicketDe.internal(_root);
	late final TranslationsSettingsDrivingModeDe driving_mode = TranslationsSettingsDrivingModeDe.internal(_root);
	late final TranslationsSettingsAppInfoDe app_info = TranslationsSettingsAppInfoDe.internal(_root);
	late final TranslationsSettingsCreditsDe credits = TranslationsSettingsCreditsDe.internal(_root);
	late final TranslationsSettingsWoautoServerDe woauto_server = TranslationsSettingsWoautoServerDe.internal(_root);
	late final TranslationsSettingsShareDe share = TranslationsSettingsShareDe.internal(_root);
	late final TranslationsSettingsFeedbackDe feedback = TranslationsSettingsFeedbackDe.internal(_root);
	late final TranslationsSettingsDataSecurityDe data_security = TranslationsSettingsDataSecurityDe.internal(_root);
	late final TranslationsSettingsAppDataDe app_data = TranslationsSettingsAppDataDe.internal(_root);
}
...
class TranslationsDialogNotificationsDe {
	...
	// Translations
	late final TranslationsDialogNotificationsNaDe na = TranslationsDialogNotificationsNaDe.internal(_root);
	late final TranslationsDialogNotificationsDeniedDe denied = TranslationsDialogNotificationsDeniedDe.internal(_root);
	late final TranslationsDialogNotificationsSentDe sent = TranslationsDialogNotificationsSentDe.internal(_root);
	late final TranslationsDialogNotificationsExpiringDe expiring = TranslationsDialogNotificationsExpiringDe.internal(_root);
}
...
class TranslationsDialogCarBottomSheetDe {
	...
	// Translations
	late final TranslationsDialogCarBottomSheetSyncDe sync = TranslationsDialogCarBottomSheetSyncDe.internal(_root);
	late final TranslationsDialogCarBottomSheetSyncedDe synced = TranslationsDialogCarBottomSheetSyncedDe.internal(_root);
	late final TranslationsDialogCarBottomSheetSharingDe sharing = TranslationsDialogCarBottomSheetSharingDe.internal(_root);
}
...
class TranslationsDialogMapsDe {
	...
	// Translations
	late final TranslationsDialogMapsDrivingModeDe driving_mode = TranslationsDialogMapsDrivingModeDe.internal(_root);
	late final TranslationsDialogMapsLocationDeniedDe location_denied = TranslationsDialogMapsLocationDeniedDe.internal(_root);
}
...
class TranslationsDialogHistoryDe {
	...
	// Translations
	late final TranslationsDialogHistoryInfoDe info = TranslationsDialogHistoryInfoDe.internal(_root);
	late final TranslationsDialogHistoryDeleteDe delete = TranslationsDialogHistoryDeleteDe.internal(_root);
}
...
class TranslationsDialogAppDataDe {
	...
	String get subtitle => 'Bist du sicher, dass du alle App Daten löschen? Dein Account bleibt bestehen.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'dialog.app_data.subtitle': return 'Bist du sicher, dass du alle App Daten löschen? Dein Account bleibt bestehen.';
